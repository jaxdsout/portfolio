    ...
    return (
      <div className="container my-2 mt-4">
        ...
        <div className="col-12 col-md-6 p-2">
            ...
            <div className="d-flex justify-content-between mt-3 align-items-baseline text-box p-3">
              ...
              <div>
                ...
                <Link to="https://plotter-w3vt.onrender.com/#/home/" target="_blank" rel="noopener noreferrer"> 
                  <i className="bi bi-link sub-icon" title="Deployed"></i>
                </Link>
              </div>
            </div>
          ...
          <div className="col-12 col-md-6 p-2">
            <div className="thumbnail-container">
              ...
              <p className="text-white">Bid-based storefront for fictitious art gallery.</p>
              <div>
                <i class="prog-icon devicon-django-plain"></i>
                <i class="prog-icon devicon-react-original"></i>
