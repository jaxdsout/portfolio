            ...
            <div className="w-full md:w-1/2 p-2 text-white">
                ...
                <div className="bg-white/5 p-8 mb-6 rounded-lg text-sm">
                    ...
                    <div className="flex flex-row justify-center p-3 rounded">
                        ...
                        <i className="text-[4rem] p-2 flex-shrink-1 devicon-express-original" title="Express"></i>
                    ...
                    <div className="flex justify-center p-3 rounded">
                        ...
                        <i className="text-[4rem] p-2 flex-shrink-1 devicon-sqlite-plain" title="SQLite"></i>
                        <i className="text-[4rem] p-2 flex-shrink-1 devicon-mongodb-plain" title="MongoDB"></i>
                    ...
                    <div className="flex justify-center p-3 rounded">
                        ...
                        <i className="text-[4rem] p-2 flex-shrink-1 devicon-jupyter-plain" title="Jupyter"></i>
                    ...
                    <div className="flex justify-center p-3 rounded">
                        ...
                        <i className="text-[4rem] p-2 flex-shrink-1 devicon-postman-plain" title="Postman"></i>
