                    ...
                    <div className="flex flex-col mt-3 items-start p-3 rounded-lg bg-white/5 text-white border-[0.05rem] border-white/5">
                        <div className="flex flex-row items-start justify-between w-full">            
                            ...
                            <div className="flex flex-row items-start">
                                <a href={links[1]} target="_blank" rel="noopener noreferrer" style={{ color: hovered === "repo" ? accent : "white" }} onMouseEnter={() => setHovered('repo')} onMouseLeave={() => setHovered(null)} >
                                ...
                                <a href={links[0]} target="_blank" rel="noopener noreferrer" style={{ color: hovered === "link" ? accent : "white" }} onMouseEnter={() => setHovered('link')} onMouseLeave={() => setHovered(null)}>
