            ...
            <motion.div className="flex flex-col items-center justify-center bg-white/5 p-8 rounded-lg text-sm text-white border-[0.05rem] border-white/5" style={{ zIndex: 4 }}>
                <div className="flex flex-row items-center justify-between p-2 rounded-lg bg-white/5 text-white border-[0.05rem] border-white/5 w-11/12">
                    <button 
                        ...
                        style={{ color: hovered === "back" ? '#e6a157' : "white" }} 
                        onClick={handleBack} 
                    ...
                    <h3 className="font-ralewayBlack font-black tracking-wider text-nowrap text-[1.2rem] ml-1"> 
                        ABOUT ME
                    </h3>
                    <div className='flex flex-row py-6 items-center justify-center text-white text-nowrap'>
                        <a className='px-2' href={"mailto:jaxon.southern@mac.com"}>
                        ...
                        <a className='px-2' href={"http://www.github.com/jaxdsout"} target="_blank" rel="noopener noreferrer">
                        ...
                        <a className='px-2' href={"https://www.linkedin.com/in/jaxonsouthern/"} target="_blank" rel="noopener noreferrer">
                ...
                <div className="mt-4 max-w-[580px] h-[380px] flex flex-col items-center text-center py-4 px-2 bg-white/10 rounded-xl text-sm">
