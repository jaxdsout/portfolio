...
export default function Nav ({ title, accent, links }) {
    ...
    return (
        <div className="flex flex-row items-center justify-between p-2 rounded-lg bg-white/5 text-white border-[0.05rem] border-white/5 w-11/12">
            <button 
                className='ml-4 mr-4 transition ease-out active:translate-y-1' 
            ...
            <div className="flex flex-row items-center">
                {title !== 'ABOUT ME' ? (
                    ...
                    className="px-2 active:translate-y-1" 
                ...
                >
                    ...
                    <>
                    <a className='px-2 active:translate-y-1' href={links[0]}>
                    ...
                    <a className='px-2 active:translate-y-1' href={links[1]} target="_blank" rel="noopener noreferrer">
                    ...
                    <a className='px-2 active:translate-y-1' href={links[2]} target="_blank" rel="noopener noreferrer">
